...
//  fsubject	VARCHAR2(500)		NULL -- 매물제목
 ...
 private String fsubject,aminal,fcharter,built,veranda,mpurpo,foption,fsecuri,shortrent,monthly,charter;
...
public String getAminal() {
	return aminal;
}
public void setAminal(String aminal) {
	this.aminal = aminal;
}
