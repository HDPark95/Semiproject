	...
	<tr>
		...
		<td id="coltd1_2" style="width: 630px;"><label id="t1addr1_1"><a
				...
				style="color: black;"><span id="mainsubject">${list.subject}</span><br />
					<b>[${list.yongdo}]</b><br />${list.addr}</a></label> <br /> <label
			id="t1addr1_2" style="font-size: 11pt; height: 6px;">토지면적
				${list.tweight}㎡/건물면적 ${list.bweight}㎡</label><br /> <label id="t1addr1_3"
			style="font-size: 11pt; height: 6px;"><b>경매만료기일</b>&nbsp;&nbsp;<span
				style="color: blue; font-weight: bold;">${list.enddate}</span></label></td>
		...
		<td style="padding-left: 3px;"><b>${list.ideprice}</b><br /> <span
