...
<div class="container" >
	<form class="form-horizontal" action="inforDetailUpdate" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 container">
				<input type="text" class="form-control" name="email" readonly="readonly" value="${vo.email }">
			</div>
		</div>
		<div class="form-group">
			<label for="inputName" class="col-sm-2 control-label">이름</label>
			<div class="col-sm-3 container">
				<input type="text" class="form-control" name="name" readonly="readonly" value="${vo.name }">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 container">
				<input type="text" class="form-control" name="tel" readonly="readonly" value="${vo.tel }">
			</div>
		</div>
