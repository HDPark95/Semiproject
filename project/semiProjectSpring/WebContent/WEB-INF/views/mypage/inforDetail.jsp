...
<div class="container membertarget" id="">
	...
	<form class="form-horizontal" action="inforDetailUpdate" method="post">
		...
		<div class="container" id="signup"
			...
			<button type="button" class="btn btn-success btn-lg" id="inforDetailUpdate_btn">수정하기</button>
...
<script>
	$(function() {
		...
		$('#inforDetailUpdate_btn').click(function() {
			$.ajax({
				url : "redirect:sinforDetailUpdate" ,
				type : "post" ,
				data : {aid : $('#aid').val() ,
						dname : $('#dname').val() ,
						dtel : $('#dtel').val()},
				success : function(result) {
					$('.membertarget').html(result);
				}
			});
		});
