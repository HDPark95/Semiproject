...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
					...
					<table id="customers">
						...
						<tr>
							...
							<td><a href="goupdateCommercial?pdnum=${pro.pdnum}&aid=${user.aid}">${pro.atclfetrdesc}</a></td>
							<td>${pro.plocation }</td>
							<td><button onclick="deleteCommercial?pdnum=${pro.pdnum}&aid=${user.aid}" class="btn btn-primary btn-sm productdescmodal bg-green">등록<br>취소</button></td>
						</tr> 
						</c:forEach>
					</table>
