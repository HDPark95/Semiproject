...
<body>
	...
	<div id="container">
	<div class="to">
		<span class="bb" id="basic">3개월</span> <span class="bb" id="st">6개월</span>
		<span class="bb" id="pr" style="right: 60px;">12개월</span>
	...
	<div class="col-md-8 div-table">
		<form method="post" action="pay1">
			<table class="aa">
					...
					<tr>
						<td><input type="button" value="뒤로가기" id="ee"
							onclick="location='semi.Project?page=community&code=5'">
							<input type="submit" value="다음" id="ee"
							style="background-color: green;" onclick="location='pay1'">
						</td>
					</tr>
